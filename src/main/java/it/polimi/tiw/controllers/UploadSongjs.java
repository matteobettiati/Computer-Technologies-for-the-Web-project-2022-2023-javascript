...
@WebServlet("/UploadSongjs")
@MultipartConfig 		
public class UploadSongjs extends HttpServlet{
	...
	public void doPost(HttpServletRequest request , HttpServletResponse response)throws ServletException,IOException{
		...
		if(!(genre.equals("Classic") || genre.equals("Pop") || genre.equals("Rock") || genre.equals("Jazz") || genre.equals("Rap"))) {
			error += "Invalid genre;";
		}
